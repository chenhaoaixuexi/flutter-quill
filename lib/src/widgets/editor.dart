...
class QuillEditor extends StatefulWidget {
  ...
  final Future<bool> Function(String text, TextSelection selection)? onTextPaste;
...
class QuillEditorState extends State<QuillEditor> implements EditorTextSelectionGestureDetectorBuilderDelegate {
  ...
  Widget build(BuildContext context) {
    ...
    final child = RawEditor(
      ...
      onTextPaste: widget.onTextPaste,
...
class RenderEditor extends RenderEditableContainerBox with RelayoutWhenSystemFontsChangeMixin implements RenderAbstractEditor {
  ...
  void performLayout() {
    ...
    final innerConstraints =
        BoxConstraints.tightFor(width: math.min(_maxContentWidth ?? double.infinity, constraints.maxWidth)).deflate(resolvedPadding!);
